...
#ifndef INCLUDED_DisplayEnumerator_Windows_cpp_GUID_D16944F8_6E45_4A1A_84F3_7430809FF604
#define INCLUDED_DisplayEnumerator_Windows_cpp_GUID_D16944F8_6E45_4A1A_84F3_7430809FF604
...
DisplayEnumerator_Windows::DisplayEnumerator_Windows()
{
    // do nothing
}
...
void DisplayEnumerator_Windows::update()
{
...
std::vector<Display> DisplayEnumerator_Windows::getDisplayAdapters()
{
    return displays_;
}

std::pair<UINT32, UINT32> DisplayEnumerator_Windows::getBufferSizes(const UINT32 query_flags)
{
...
std::pair<PathInfoList, ModeInfoList> DisplayEnumerator_Windows::getDisplayInformation()
{
...
Display DisplayEnumerator_Windows::getDisplay(const DISPLAYCONFIG_PATH_INFO& path_info, const ModeInfoList& mode_info)
{
    // TODO
    Display display;
...
DisplayAdapter DisplayEnumerator_Windows::getDisplayAdapter(const DISPLAYCONFIG_PATH_INFO& path_info, const ModeInfoList& mode_info)
{
    // TODO
...
std::string DisplayEnumerator_Windows::getAdapterName(const DISPLAYCONFIG_PATH_INFO& path_info)
{
...
#endif // INCLUDED_DisplayEnumerator_Windows_cpp_GUID_D16944F8_6E45_4A1A_84F3_7430809FF604
