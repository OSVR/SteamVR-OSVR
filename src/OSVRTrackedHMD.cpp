...
bool OSVRTrackedHMD::GetBoolTrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError* error)
{
...
#include "ignore-warning/switch-enum"
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetBoolTrackedDeviceProperty(): Requested property: " << prop << "\n";
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetBoolTrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}

float OSVRTrackedHMD::GetFloatTrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError* error)
{
...
#include "ignore-warning/switch-enum"
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetFloatTrackedDeviceProperty(): Requested property: " << prop << "\n";
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetFloatTrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}

int32_t OSVRTrackedHMD::GetInt32TrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError* error)
{
...
#include "ignore-warning/switch-enum"
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetInt32TrackedDeviceProperty(): Requested property: " << prop << "\n";
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetInt32TrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}

uint64_t OSVRTrackedHMD::GetUint64TrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError* error)
{
...
#include "ignore-warning/switch-enum"
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetUint64TrackedDeviceProperty(): Requested property: " << prop << "\n";
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetUint64TrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}

vr::HmdMatrix34_t OSVRTrackedHMD::GetMatrix34TrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError* error)
{
...
#include "ignore-warning/switch-enum"
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetMatrix34TrackedDeviceProperty(): Requested property: " << prop << "\n";
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetMatrix34TrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}

uint32_t OSVRTrackedHMD::GetStringTrackedDeviceProperty(vr::ETrackedDeviceProperty prop, char* value, uint32_t buffer_size, vr::ETrackedPropertyError *error)
{
    ...
    OSVR_LOG(properties) << "OSVRTrackedHMD::GetStringTrackedDeviceProperty(): Requested property: " << prop << "\n";
...
std::string OSVRTrackedHMD::GetStringTrackedDeviceProperty(vr::ETrackedDeviceProperty prop, vr::ETrackedPropertyError *error)
{
...
#include "ignore-warning/pop"
    ...
    OSVR_LOG(warn) << "OSVRTrackedHMD::GetStringTrackedDeviceProperty(): Unknown property " << prop << " requested.\n";
    if (error)
        *error = vr::TrackedProp_UnknownProperty;
    return default_value;
}
